...
export default async function ProjectDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [{ data: project }, { data: customers }, { data: activity }, { data: estimates }, { data: contracts }] = await Promise.all([

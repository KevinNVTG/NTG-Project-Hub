...
export default async function SettingsPage() {
  ...
  return (
    <AppShell title="Company Settings">
      ...
      <div className="card settings-feature-card"><div><span className="settings-kicker">Estimating</span><h3>Stone Slab Pricing</h3><p>Maintain your customer-facing slab price library and add selected stone directly into estimates without retyping descriptions or prices.</p></div><Link className="primary-link-button" href="/settings/stone-slabs">Manage Stone Slabs</Link></div>
    </AppShell>
  )
}

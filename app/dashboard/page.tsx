...
export default async function DashboardPage() {
  ...
  const [{ count: activeCount }, { count: customerCount }, { count: openEstimateCount }, { data: estimates }, { data: projects }] = await Promise.all([

...
export default async function DashboardPage() {
  ...
  const [{ count: activeCount }, { count: customerCount }, { count: openEstimateCount }, { count: contractCount }, { data: estimates }, { data: projects }] = await Promise.all([

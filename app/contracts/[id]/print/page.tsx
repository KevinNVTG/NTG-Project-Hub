...
const clauses = [
  ['5. TERMINATION', 'This Agreement terminates upon completion of the Services. Neither party may terminate the Agreement before completion unless there is reasonable cause.'],
  ['6. CONTRACTOR EXPENSES', 'The Contractor is responsible only for the following expenses: thinset mortar, grout, waterproofing, anti-fracture membrane, cement board, countertop material, and fabrication. The Client agrees to pay within 30 days of notice for any other expense directly associated with the Services. Upon request, the Contractor may provide receipts or other proof of purchase.'],

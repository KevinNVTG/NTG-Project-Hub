...
const PRESETS = {
  ...
  hybrid_union: `Nevada Tile & Granite is pleased to submit this proposal for the referenced commercial tile and stone work. The proposed compensation structure combines owner/GC-established material allowances with Time & Materials labor and other authorized project costs. Our team is prepared to provide qualified supervision and union field labor in support of the project's schedule, sequencing, and installation requirements.

Material allowances are identified separately for budgeting and reconciliation, while union labor and other approved T&M costs will be billed at the Nevada Tile & Granite customer billing rates and markups stated in this proposal. Any estimated project cost shown is provided for budgeting purposes only and does not replace the agreed T&M and allowance reconciliation terms.`,
...
export function ProposalIntroductionPresets({ name='executive_summary', defaultValue='' }: { name?: string, defaultValue?: string }) {
  ...
  return <div className="field span-3">
    ...
    <div className="quick-actions-inline" style={{marginBottom:'8px', flexWrap:'wrap'}}>
      ...
      <button className="secondary-button" type="button" onClick={()=>apply('hybrid_union')}>Hybrid Allowance + T&amp;M</button>
